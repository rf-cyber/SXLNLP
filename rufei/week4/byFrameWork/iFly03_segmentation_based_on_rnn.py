...
def main():
    ...
    vocab_path = r"D:\badou\gitRepository\SXLNLP\rufei\week4\datasets\rnn_segment\chars.txt"  # 字表文件路径
    corpus_path = r"D:\badou\gitRepository\SXLNLP\rufei\week4\datasets\corpus\corpus.txt"  # 语料文件路径
...
if __name__ == "__main__":
    ...
    predict("iFly03_model.pth", r"D:\badou\gitRepository\SXLNLP\rufei\week4\datasets\rnn_segment\chars.txt", input_strings)
